...
export function AssignmentCard({
  ...
  return (
    <div className="flex flex-row items-center justify-between border border-border/80 bg-card hover:bg-card/75 rounded-xl pl-4 py-4 pr-12 gap-4 transition-colors w-full">
